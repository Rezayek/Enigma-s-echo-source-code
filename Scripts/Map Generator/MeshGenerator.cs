...
public class MeshGenerator
{
    ...
    public static MeshData GenerateTerrainMesh(float [,] heightMap, MeshSettings meshSettings,  int levelOfDetail)
    {
        ...
        int numVerticesPerLine = meshSettings.numberOfVerticesPerLine;

        Vector2 topLeft = new Vector2(-1, 1) * meshSettings.meshWorldSize / 2f;


        MeshData meshData = new MeshData(numVerticesPerLine: numVerticesPerLine, skipIncrement: skipIncrement, useFlatShading: meshSettings.useFlatShading);
    ...
    public class MeshData
    {
        ...
        Vector3[] CalculateNormals()
        {
            ...
            for(int i = 0; i< triangleCount; i++)
            {
                ...
                Vector3 triangleNormal = SurfaceNormalFromIndices(indexA: vertexIndexA, indexB: vertexIndexB, indexC: vertexIndexC);
